...
1. [](#improved)
    ...
    * Simplified navigation macro
1. [](#bugfix)
    * Fixed issue with Prism Highlight [prism-highlight#1](https://github.com/trilbymedia/lev-plugin-prism-highlight/issues/1)
...
1. [](#improved)
    * Updated to use new `LEV` core language prefix
...
1. [](#new)
    * Set Dependency of Lev 1.5.10+ which has support for new **Deferred Block** Twig extension
