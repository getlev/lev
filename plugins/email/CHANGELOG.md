...
1. [](#bugfix)
    * Fixed `Invalid resource theme://` on CLI command `test-email` on Lev 1.6.21 and later versions [#128](https://github.com/getgrav/grav-plugin-email/issues/128)
...
1. [](#new)
    ...
    * Switched to SwiftMailer v.6.1.3 (requires PHP7/Lev 1.6)
