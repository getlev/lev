...
class Email
{
    ...
    {
        return Lev::instance()['config']->get('plugins.email.mailer.engine') !== 'none';
    }
    ...
    {
        return Lev::instance()['config']->get('plugins.email.debug') == 'true';
    }
    ...
    {
        $queue_path = Lev::instance()['locator']->findResource('app://data', true) . '/email-queue';
    ...
    public static function flushQueue()
    {
        ...
        $config = $lev['config']->get('plugins.email.queue');
