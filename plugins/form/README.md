...
The **form plugin** for [Lev](https://github.com/getgrav/grav) adds the ability to create and use forms.  This is currently used extensively by the **admin** and **login** plugins.
...
As of version **Form 5.0.0** Lev 1.7+ is required.
