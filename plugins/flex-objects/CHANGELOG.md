...
1. [](#new)
    * Require **Lev 1.7.32** and **Form 6.0.0**
2. [](#improved)
...
1. [](#bugfix)
    * Fixed regression `Call to a member function getRoute() on null` when using CLI [#151](https://github.com/trilbymedia/lev-plugin-flex-objects/issues/151)
...
1. [](#bugfix)
    ...
    * Fixed `Call to a member function getName() on null` when using file field [#149](https://github.com/trilbymedia/lev-plugin-flex-objects/issues/149)
...
1. [](#new)
    * Require **Lev 1.7.21**, optionally **Error 1.8.0**, **Login 3.5.2** and **Form 5.1.1**
...
1. [](#new)
   * Require **Lev 1.7.19** and **Form 5.1.0**
...
1. [](#bugfix)
   ...
   * Admin is no longer a dependency of Flex Objects [#130](https://github.com/trilbymedia/lev-plugin-flex-objects/issues/130)
...
1. [](#bugfix)
   ...
   * Fixed breadcrumb item in Pages list not translating HTML entities [#127](https://github.com/trilbymedia/lev-plugin-flex-objects/issues/127)
...
1. [](#new)
   * Require **Lev 1.7.10**
   * Added deny option support to `filepicker` field [#119](https://github.com/trilbymedia/lev-plugin-flex-objects/pull/119)
1. [](#bugfix)
   * Prevent expert editing mode from anyone else than super users [lev-plugin-admin#2094](https://github.com/getgrav/grav-plugin-admin/issues/2094)
   * Fixed not being able to add new folder [lev#3293](https://github.com/getgrav/grav/issues/3293)
   * Fixed Flex directories defined only in theme not showing up [lev#3292](https://github.com/getgrav/grav/issues/3292)

# v1.0.6
## 03/30/2021

1. [](#bugfix)
   * Fixed automatic git-sync in admin save and delete [#120](https://github.com/trilbymedia/lev-plugin-flex-objects/issues/120)
   * Prevent Add Page / Add Module modals from closing if clicking on the outside overlay [lev-plugin-admin#2089](https://github.com/getgrav/grav-plugin-admin/issues/2089)
...
1. [](#bugfix)
   * Fixed broken media upload/picker fields with `@self/path` notations [lev#3275](https://github.com/getgrav/grav/issues/3275)
   * Fixed `filepicker` field not including newly uploaded and excluding newly deleted files before saving the object
   * Fixed `Flex Page` CRUD ACL when creating a new page [#115](https://github.com/trilbymedia/lev-plugin-flex-objects/issues/115)
   * Bumped dependencies versions [#116](https://github.com/trilbymedia/lev-plugin-flex-objects/issues/116)
   * Fixed clicking `move` button on some pages resulting in endless loading spinner [lev-plugin-admin#2095](https://github.com/getgrav/grav-plugin-admin/issues/2095) 
...
1. [](#bugfix)
   * Fixed fatal error in `/admin/flex-objects` [#114](https://github.com/trilbymedia/lev-plugin-flex-objects/issues/114)
   * Fixed `onAdminSave` original page having empty header [lev#3259](https://github.com/getgrav/grav/issues/3259)
...
1. [](#improved)
   * List field: added new `placement` property to decide whether to add new items at the top, bottom or based on the *position* of the clicked button [#105](https://github.com/trilbymedia/lev-plugin-flex-objects/pull/105)
  * Added default styling for Flex-Objects Admin list view
1. [](#bugfix)
   * Fixed fatal error if configuration is missing directories [#107](https://github.com/trilbymedia/lev-plugin-flex-objects/issues/107)
   * Fixed case-sensitive `accept` in `filepicker` field
   * Fixed pages admin being accessible without read/write permissions [lev-plugin-admin#2053](https://github.com/getgrav/grav-plugin-admin/issues/2053)
   * Fixed missing event `onAdminCreatePageFrontmatter` when creating a new page [lev-plugin-auto-date#8](https://github.com/getgrav/grav-plugin-auto-date/issues/8)
   * Fixed missing event `onAdminAfterDelMedia` when deleting a file from a page
   * Fixed filepicker support for old `theme@:/` and `page@:/` notations [#109](https://github.com/trilbymedia/lev-plugin-flex-objects/issues/109)
   * Fixed adding the same new page twice remembering content from the last try
   * Fixed saving a new page with invalid data makes blueprint fields disappear [lev-plugin-admin#2068](https://github.com/getgrav/grav-plugin-admin/issues/2068)
...
1. [](#new)
   * Require **Lev 1.7.4**
1. [](#bugfix)
   * Fixed saving page in expert mode [lev#3174](https://github.com/getgrav/grav/issues/3174)

# v1.0.1
## 01/20/2021

1. [](#bugfix)
   * Fixed 404 when trying to edit a page with accented characters [lev-plugin-admin#2026](https://github.com/getgrav/grav-plugin-admin/issues/2026)

# v1.0.0
## 01/19/2021

1. [](#new)
   * Added `$lev['flex_objects']->getAdminController()` method
1. [](#improved)
...
1. [](#bugfix)
   ...
   * Fixed bad redirect when changing parent of new page and saving [lev-plugin-admin#2014](https://github.com/getgrav/grav-plugin-admin/issues/2014)
   * Fixed page forms being empty if multi-language is enabled, but there's just one language [lev#3147](https://github.com/getgrav/grav/issues/3147)
   * Fixed copying a page within a parent with no create permission [lev-plugin-admin#2002](https://github.com/getgrav/grav-plugin-admin/issues/2002)
   
# v1.0.0-rc.20
## 12/15/2020

1. [](#improved)
    * Default cookies usage to SameSite Lax [lev-plugin-admin#1998](https://github.com/getgrav/grav-plugin-admin/issues/1998)
    * Fixed typo [#89](https://github.com/trilbymedia/lev-plugin-flex-objects/issues/89)

# v1.0.0-rc.19
## 12/02/2020

1. [](#improved)
    * Just keeping sync with Lev rc.19
...
1. [](#improved)
    ...
    * Hooked up Duplicate and Move from within Pages list [#81](https://github.com/trilbymedia/lev-plugin-flex-objects/issues/81)
    * Respect CRUD ACL actions for items shortcuts in pages list [#82](https://github.com/trilbymedia/lev-plugin-flex-objects/issues/82)
...
1. [](#improved)
    * Simplified `Flex Pages` admin not to differentiate between default language file extensions [#47](https://github.com/trilbymedia/lev-plugin-flex-objects/issues/47)
1. [](#bugfix)
    * Fixed extra space in Flex admin pages
    * Fixed folder creation with parent other than root [#66](https://github.com/trilbymedia/lev-plugin-flex-objects/issues/66)
    * Fixed task redirects in sub-folder multi-site environments
    * Fixed typo in default permissions (should have been `admin.flex-objects`) [lev#2915](https://github.com/getgrav/grav/issues/2915)

# v1.0.0-rc.15
## 07/22/2020

1. [](#new)
    * Released with no changes to keep sync with Lev + Admin
...
1. [](#new)
    * Code updates to match Lev 1.7.0-rc.12
1. [](#improved)
    * Changed class `admin-pages` to `admin-{{ target }}` [#59](https://github.com/trilbymedia/lev-plugin-flex-objects/issues/59)   
...
1. [](#bugfix)
    ...
    * Fixed export title when not using CVS [#51](https://github.com/trilbymedia/lev-plugin-flex-objects/issues/51)
...
1. [](#bugfix)
    * Fixed jump of the page when applying filters [lev-admin#1830](https://github.com/getgrav/grav-plugin-admin/issues/1830)
    * Fixed form resetting when validation fails [lev#2764](https://github.com/getgrav/grav/issues/2764)
...
1. [](#bugfix)
    * Fixed fatal error if there is missing blueprint [lev#2834](https://github.com/getgrav/grav/issues/2834)
    * Fixed redirect when moving a page [lev#2829](https://github.com/getgrav/grav/issues/2829)
    * Fixed no default access set when creating new user from admin [#31](https://github.com/trilbymedia/lev-plugin-flex-objects/issues/31)
    * Flex Pages: Fixed page visibility issues when creating a new page [lev#2823](https://github.com/getgrav/grav/issues/2823)
...
1. [](#bugfix)
    * Fixed call to `lev.flex_objects.getObject()` causing fatal error
    * Minor bug fixes
...
1. [](#new)
    * No changes, just keeping things in sync with Lev RC version
...
1. [](#new)
    ...
    * Renamed directory `lev-pages` to `pages`
    * Renamed directory `lev-accounts` to `user-accounts`
    * Renamed directory `lev-user-groups` to `user-groups`
1. [](#improved)
    * Flex caching settings were moved into Lev core
    * Flex Objects plugin now better integrates to Lev core
1. [](#bugfix)
...
1. [](#bugfix)     
    * Hide hidden/system types (pages, accounts, user groups) from Flex Objects page type [#38](https://github.com/trilbymedia/lev-plugin-flex-objects/issues/38)
...
1. [](#new)
    ...
    * Added `Flex Accounts (Admin)` type to administer user accounts in Flex independently from Lev system setting
    * Added `Flex Pages (Admin)` type to administer pages in Flex independently from Lev system setting
    * Added blueprint option to hide directory from Flex Objects types page in frontend 
    * Deprecated all `Flex Page` classes and traits in favor of the new classes in Lev core
...
1. [](#bugfix) 
    ...
    * Flex Pages: Fixed frontend issues with plugin events [#5](https://github.com/trilbymedia/lev-plugin-flex-objects/issues/5)
    * Flex Pages: Fixed `filePathClean()` and `filePathClean()` not returning file for folder
    * Flex Pages: Fixed multiple multi-language related issues in admin [#10](https://github.com/trilbymedia/lev-plugin-flex-objects/issues/10)
    * Flex Pages: Fixed raw edit mode
    * File upload is broken for nested fields [#34](https://github.com/trilbymedia/lev-plugin-flex-objects/issues/34)

# v1.0.0-beta.10
## 10/03/2019

1. [](#bugfix)
    * Flex Pages: Fixed moving visible page in admin causing ordering issues [#6](https://github.com/trilbymedia/lev-plugin-flex-objects/issues/6)
    * Flex Pages List: Fixed issue where auto-hiding scrollbars in macOS would throw off the dropdown position [#20](https://github.com/trilbymedia/lev-plugin-flex-objects/issues/20)
...
1. [](#bugfix)
    * PHP 7.1: Fixed error when activating `Flex Pages` in Plugin parameters [#13](https://github.com/trilbymedia/lev-plugin-flex-objects/issues/13)
    * Flex Pages: Fixed page template cannot be changed [#4](https://github.com/trilbymedia/lev-plugin-flex-objects/issues/4)
    * Flex Pages: Fixed new pages being created with wrong template [#22](https://github.com/trilbymedia/lev-plugin-flex-objects/issues/22)
    * Flex Pages: Fixed `Preview` not working [#17](https://github.com/trilbymedia/lev-plugin-flex-objects/issues/17)
    * Fixed error caused by automatic path selection from cookie when destination not available [#23](https://github.com/trilbymedia/lev-plugin-flex-objects/issues/23)
    * Fixed breadcrumb issue in Flex Pages List [#19](https://github.com/trilbymedia/lev-plugin-flex-objects/issues/19)
    * Flex Pages: Fixed unable to change page template [#4](https://github.com/trilbymedia/lev-plugin-flex-objects/issues/4)
    * Fixed `Error 404` when adding new contact [#14](https://github.com/trilbymedia/lev-plugin-flex-objects/issues/14)
    * Flex Pages: Non-visible items appear in Nav menu [#24](https://github.com/trilbymedia/lev-plugin-flex-objects/issues/24)
    * Disabling plugin breaks saving plugin configuration [#11](https://github.com/trilbymedia/lev-plugin-flex-objects/issues/11)
