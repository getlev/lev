...
use Lev\Plugin\FlexObjects\Events\FlexTaskEvent;
...
class ObjectController extends AbstractController
{
    ...
    public function taskCreate(ServerRequestInterface $request): ResponseInterface
    {
        ...
        $this->lev->fireEvent("flex.{$this->type}.task.create.after", $event);
    ...
    public function taskUpdate(ServerRequestInterface $request): ResponseInterface
    {
        ...
        $this->lev->fireEvent("flex.{$this->type}.task.update.after", $event);
    ...
    public function taskDelete(ServerRequestInterface $request): ResponseInterface
    {
        ...
        $this->lev->fireEvent("flex.{$this->type}.task.delete.after", $event);
    ...
    {
        /** @var Route $route */
        $route = $this->lev['route']->withLevParam('task', null)->withLevParam($type, $name);
        $object = $this->getObject();
