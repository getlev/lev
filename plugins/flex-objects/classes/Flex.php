...
use Lev\Framework\Flex\Interfaces\FlexCommonInterface;
...
use Lev\Plugin\FlexObjects\Table\DataTable;
...
class Flex implements FlexInterface
{
    ...
    {
        $map = [
            'blueprints://flex-objects/pages.yaml' => 'blueprints://flex-objects/lev-pages.yaml',
            'blueprints://flex-objects/user-accounts.yaml' => 'blueprints://flex-objects/lev-accounts.yaml',
            'blueprints://flex-objects/user-groups.yaml' => 'blueprints://flex-objects/lev-user-groups.yaml'
        ];
