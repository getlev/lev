...
let XHRUUID = 0;
const LEV_CONFIG = typeof global.LevConfig !== 'undefined' ? global.LevConfig : global.LevAdmin.config;
...
export class FlexPages {
    ...
    static createItem(config, item, finder) {
        ...
        // const href = `${LEV_CONFIG.current_url}/${item.route.raw}`.replace('//', '/');
    ...
    static createItemContent(config, item) {
        ...
        const route = `${LEV_CONFIG.current_url}/${item.route.raw}`.replace('//', '/');
    ...
    <div class="action-bar">
        ...
        ${canCopy ? `<a href="${route}/task:copy/admin-nonce:${LEV_CONFIG.admin_nonce}" class="dropdown-item" title="Duplicate" href="#modal-page-copy" data-remodal-target="modal-page-copy" data-copy-flex-page data-title="${item.title}" data-folder="${item['item-key']}"><i class="fa fa-fw fa-copy"></i></a>` : ''}
        ${canMove ? '<a href="#" class="dropdown-item" title="Move (coming soon)"><i class="fa fa-fw fa-arrows"></i></a>' : ''}
        ${canDelete ? `<a href="#delete" data-remodal-target="delete" data-delete-url="${route}/task:delete/admin-nonce:${LEV_CONFIG.admin_nonce}" class="dropdown-item danger" title="Delete"><i class="fa fa-fw fa-trash-o"></i></a>` : ''}
    </div>
