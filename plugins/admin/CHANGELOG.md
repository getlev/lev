...
1. [](#improved)
   * Exposed `UriToMarkdown` util (`Lev.default.Utils.UriToMarkdown`) in admin, to convert links/images
1. [](#bugfix)
...
1. [](#new)
   * Require **Lev 1.7.32**, **Form 6.0.0**, **Login 3.7.0**, **Email 3.1.6** and **Flex Objects 1.2.0**
2. [](#improved)
...
1. [](#new)
   * Added new local Multiavatar (local generation). **This will be default in Lev 1.8**
2. [](#bugfix)
...
1. [](#new)
   ...
   * Requires Lev `v1.7.27` and Login `v3.6.2`
2. [](#improved)
...
1. [](#bugfix)
    * Fixed regression `Argument 4 passed to Lev\Plugin\Form\TwigExtension::prepareFormField() must be of the type array` [#2177](https://github.com/getgrav/grav-plugin-admin/issues/2177)
...
1. [](#new)
    * Require **Lev 1.7.19** and **Form 5.1.0** and **Login 3.5.0**
...
2. [](#improved)
    ...
    * Stop using `|tu` filter, Lev already has the same logic in `|t` for admin
...
1. [](#new)
    * Added refresh action button for Folder to ease the regeneration of the slug based on the title. Available also as API entry `Lev.default.Forms.Fields.FolderField.Regenerate()` [#1738](https://github.com/getgrav/grav-plugin-admin/issues/1738)
1. [](#improved)
...
1. [](#bugfix)
    ...
    * Fixed admin controller running before setting `$lev['page']`
...
1. [](#new)
    ...
    * Updated all languages from [Crowdin](https://crowdin.com/project/lev-admin) - Please update any translations here
1. [](#improved)
...
1. [](#new)
    * Requires **Lev 1.7.4** (SemVer library moved to Lev)
...
1. [](#new)
    * Requires **Lev 1.7 and PHP 7.3.6**
    * Read about this release in the [Lev 1.7 Released](https://getgrav.org/blog/lev-1.7-released) blog post
    ...
    * Please read [Lev 1.7 Upgrade Guide](https://learn.getgrav.org/17/advanced/lev-development/lev-17-upgrade-guide) before upgrading!
1. [](#improved)
...
1. [](#improved)
    ...
    * Exposed **Cookies** class (`Lev.default.Utils.Cookies`) for developers that need it in Admin.
1. [](#bugfix)
...
1. [](#improved)
    ...
    * Added modal to confirm updating Lev as well as cool down counter before enabling Update button [#1257](https://github.com/getgrav/grav-plugin-admin/issues/1257)
...
1. [](#bugfix)
    ...
    * Stop propagation of ACL add button in ACL picker [flex-objects#83](https://github.com/trilbymedia/lev-plugin-flex-objects/issues/83)
    * Fixed missing special groups `authors` and `defaults` for pages
    * Fixed Page Move action and selection highlight in Parents selector modal [flex-objects#80](https://github.com/trilbymedia/lev-plugin-flex-objects/issues/80)
...
1. [](#new)
    ...
    * Updated `permissions` field to use new `$lev['permissions']`
    ...
    * DEPRECATED `Admin::getPermissions()`, use `$lev['permissions']->getInstances()` instead
1. [](#improved)
...
1. [](#bugfix)
    ...
    * Fixed JS bug is using empty Lev URI param key
    * Fixed bug in toggleable field being disabled with empty value (`''` `0`, `false`, `[]`...)
    * Fixed `admin_route()` twig function to work properly with Lev 1.7.0-rc.4, which fixes `Route` base
...
1. [](#new)
    * Added ability to display **Changelogs** for `Lev`, `Plugins` and `Themes`
...
1. [](#improved)
    ...
    * Lev 1.7: Updated deprecated `$page->modular()` method calls to `$page->isModule()`
...
1. [](#bugfix)
    * Fixed regression: Do not require Flex Objects plugin [lev#2653](https://github.com/getgrav/grav/issues/2653)
...
1. [](#bugfix)
    * Fixed `pages` field escaping issues, needs Lev update, too [#1990](https://github.com/getgrav/grav-plugin-admin/issues/1990)
    * Fixed Plugins references in Themes details page.
    * Fixed issue preventing purchase of Themes within Admin and redirecting instead.
...
1. [](#bugfix)
    * Fixed `Badly encoded JSON data` warning when uploading files [lev#2663](https://github.com/getgrav/grav/issues/2663)
...
1. [](#bugfix)
    ...
    * Resetting a user's password clears the user's site access [lev#2528](https://github.com/getgrav/grav/issues/2528)
...
1. [](#improved)
    ...
    * Updated language strings from https://crowdin.com/project/lev-admin
    * Use `plugins://` stream rather than `app://plugins` [#1674](https://github.com/getgrav/grav-plugin-admin/issues/1674)
1. [](#bugfix)
...
1. [](#new)
    ...
    * Added new `Logs` section to tools to allow quick view of Lev log files
1. [](#improved)
    * Improved the UI for the Parent Page Route dropdown when adding a new Page / Folder
    * Use `$lev['accounts']` instead of `$lev['users']`
...
1. [](#bugfix)
    ...
    * Fallback to page `slug` in Pages list if title is empty [lev#2267](https://github.com/getgrav/grav/issues/2267)
...
1. [](#bugfix)
    * Moved `show_modular` to proper place - Doh! [lev#2362](https://github.com/getgrav/grav/issues/2362)

# v1.8.18
## 02/12/2019

1. [](#bugfix)
    * Set default value for `show_modular` [lev#2362](https://github.com/getgrav/grav/issues/2362)

# v1.8.17
## 02/07/2019

1. [](#improved)
    * Improved Lev Core installer/updater to run installer script (if available)
    * Added `unauthorized.html.twig` file that was missing [#1609](https://github.com/getgrav/grav-plugin-admin/pull/1609)
1. [](#bugfix)
    * Fixed direct install deleting backups and logs if used with full Lev package instead of with update package
...
1. [](#bugfix)
    * Fixed Lev core update potentially spinning forever because of an error which happens after a successful upgrade
...
1. [](#improved)
    ...
    * Improved filename validation (requires Lev 1.5.3)
...
1. [](#bugfix)
    ...
    * Updated `composer.json` to better match Lev 1.5
...
1. [](#improved)
    ...
    * Switched to new Lev Yaml class to support Native + Fallback YAML libraries
...
1. [](#improved)
    ...
    * Added some new lang strings for Lev 1.5.0
1. [](#bugfix)
...
1. [](#bugfix)
    * Fix for deleting 'extra' media files [lev#2100](https://githubcom/getgrav/grav/issues/2100)

# v1.8.6
## 07/13/2018

1. [](#bugfix)
    * Force `html` for markdown preview [lev#2066](https://github.com/getgrav/grav/issues/2066)
...
1. [](#new)
    ...
    * Updated plugin dependencies (Lev >= 1.4.4, Form >=2.14.0, Login >=2.7.0, Email >=2.7.0)
1. [](#improved)
...
1. [](#bugfix)
    ...
    * Fix for page preview when `HTTP_REFERRER` is not set [lev#1930](https://github.com/getgrav/grav/issues/1930)
...
1. [](#improved)
    ...
    * Stopped Chrome from auto-completing admin user profile form [lev#1847](https://github.com/getgrav/grav/issues/1847)
...
1. [](#new)
    ...
    * Changed "made by" to Levitation from RocketTheme
1. [](#improved)
...
1. [](#improved)
    * Added code to use new `GPM::loadRemoteLev` if it exists in Gav [lev#1746](https://github.com/getgrav/grav/pull/1746)
    ...
    * Tab layout tweaks
    * Updated all language files with latest from [Crowdin](https://crowdin.com/project/lev-admin)
1. [](#bugfix)
...
1. [](#new)
    * Added ability to **order** page media (requires latest Lev update)
...
1. [](#bugfix)
    ...
    * Fixed ordering when > 100 pages [lev#1564](https://github.com/getgrav/grav/pull/1564)
...
1. [](#bugfix)
    ...
    * Expose Page Media instance to Lev Admin JS API
...
1. [](#bugfix)
    ...
    * Added `vendor` to ignores for direct install of Lev
...
1. [](#bugfix)
    * Added back `Admin::initTheme()` relying on Lev fix [#1069](https://github.com/getgrav/grav-plugin-admin/pull/1069) as it conflicts ith Gantry5
    ...
    * Added `[tmp,user]` ignores for direct install of Lev [lev#1447](https://github.com/getgrav/grav/issues/1447)
...
1. [](#bugfix)
    * Fix for regression introduced in the automatic page template switch when changing page parent [#1059](https://github.com/getgrav/grav-plugin-admin/issues/1059) [lev#1403](https://github.com/getgrav/grav/issues/1403) [#1062](https://github.com/getgrav/grav-plugin-admin/issues/1062)
...
1. [](#new)
    * User uploadable avatar (still falls back to Levatar if not provided)
1. [](#improved)
...
1. [](#new)
    * Added lang strings for `CLI_COMPATIBILITY` which is new in Lev v1.1.16
1. [](#improved)
...
1. [](#improved)
    ...
    * Allow to see plugins and themes list without internet connection. Also add a more helpful message in the "add" view [lev#1008](https://github.com/getgrav/grav/issues/1008)
1. [](#bugfix)
...
1. [](#improved)
    ...
    * Fix prompting to remove Lev itself when removing a package that requires a specific Lev version
    * Remove cli-server exception since we now have compatibility with a custom router in Lev [#1219](https://github.com/getgrav/grav/pull/1219)
1. [](#bugfix)
...
1. [](#new)
    * Updated to FontAwesome 4.7.0 with [Lev icon](http://fontawesome.io/icon/lev/)
1. [](#improved)
...
1. [](#bugfix)
    * Fixed `tmp://` stream issue with Admin updated to 1.2 before Lev updated 1.1.4
...
1. [](#improved)
    ...
    * It is now possible to sort the Plugins and Themes views by 'Name', 'Author', 'LevTeam', 'Release Date', 'Updates Available' and 'Testing' releases (if in Testing Channel), both Ascending and Descending. [#583](https://github.com/getgrav/grav-plugin-admin/issues/583)
...
1. [](#improved)
    * Updated with latest languages via [Crowdin](https://crowdin.com/project/lev-admin/)
...
1. [](#improved)
    ...
    * Copied admin-only blueprints from Lev core to the Admin plugin
...
1. [](#new)
    ...
    * Added several new languages: Arabic, Danish, Greek, Farsi, Korean, Romanian, Thai. Huge thanks to the [translation teams](https://crowdin.com/project/lev-admin)
1. [](#improved)
...
1. [](#bugfix)
    ...
    * Fix the version information after updating Lev from Admin
...
1. [](#new)
    * Added `lev ~1.1` to dependencies
    * Added a persistent message if you try to run Admin 1.1 on Lev 1.0
1. [](#improved)
...
1. [](#bugfix)
    ...
    * [Security] Don't reveal Lev filesystem path when trying to delete non-existing images
...
1. [](#new)
    * Added a pointer to Lev's contributing guide
...
1. [](#new)
    ...
    * Force timestamp on CSS/JS assets based on `LEV_GVERSION`
...
1. [](#improved)
    ...
    * Load Levatar image with protocol-less `//:` syntax
...
1. [](#improved)
    ...
    * Additional lang strings for Lev 1.0.0-rc.3
...
1. [](#improved)
    ...
    * Better preview link (requires `rtrim` filter from Lev 0.9.40)
...
1. [](#improved)
    ...
    * Added tooltips for official 'Team Lev' themes/plugins
1. [](#bugfix)
