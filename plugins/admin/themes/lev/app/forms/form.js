...
export default class Form {
    ...
    _attachToggleables() {
        let query = '[data-lev-field="toggleable"] input[type="checkbox"]';
    ...
    _attachDisabledFields() {
        ...
        this.form.on('mousedown', query.join(', '), (event) => {
            ...
            let toggle = input.closest('.form-field').find('[data-lev-field="toggleable"] input[type="checkbox"]');
    ...
    addedNodes(mutations) {
        mutations.forEach((mutation) => {
            ...
            if (mutation.addedNodes) {
                $('body').trigger('mutation._lev', mutation.target, mutation, this);
            }

            if (mutation.removedNodes) {
                $('body').trigger('mutation_removed._lev', { target: mutation.target, mutation }, this);
            }
        });
    }
}
