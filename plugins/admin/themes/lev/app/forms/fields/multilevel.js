...
$(function() {
    ...
    const refreshControls = function refreshControls(unique_identifier) {
        let element = '[data-lev-multilevel-field]';
        if (unique_identifier) {
            element = '[data-lev-multilevel-field][data-id="' + unique_identifier + '"]';
        }
    ...
    const changeAllOccurrencesInTree = function($el, current_name, new_name) {
        $el.parents('[data-lev-multilevel-field]').find('input').each(function() {
            let $input = $(this);
            if ($input.attr('name')) {
    ...
    $(document).on('mouseleave', '[data-lev-multilevel-field]', function(event) {
    ...
    $(document).on('click', '[data-lev-multilevel-field] .js__add-children', function(event) {
        let element = $(this);
    ...
    $(document).on('click', '[data-lev-multilevel-field] .js__add-sibling', function(event) {
        let element = $(this);
        let unique_container_id = element.closest('.js__multilevel-field').data('id');
    ...
    $(document).on('click', '[data-lev-multilevel-field] .js__remove-item', function(event) {
    ...
    $(document).on('focusin', '[data-lev-multilevel-field] input', function(event) {
        $(this).data('current-value', $(this).val());
    });

    // Handle field edited event
    $(document).on('change', '[data-lev-multilevel-field] input', function(event) {
        let $el = $(this);
