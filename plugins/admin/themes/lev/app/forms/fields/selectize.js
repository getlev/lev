...
export default class SelectizeField {
    constructor(options = {}) {
        ...
        $('[data-lev-selectize]').each((index, element) => this.add(element));
    ...
    add(element) {
        ...
        let data = (isInput ? element.closest('[data-lev-selectize]') : element).data('lev-selectize') || {};
    ...
    _onAddedNodes(event, target/* , record, instance */) {
        let fields = $(target).find('select.fancy, input.fancy, [data-lev-selectize]').filter((index, element) => {
