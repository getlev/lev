...
export default class ColorpickerField {
    constructor(selector) {
        ...
        this.options = Object.assign({}, this.field.data('lev-colorpicker'));
        this.built = false;
        this.attach();

        if (this.options.update) {
            this.field.on('change._lev_colorpicker', (event, field, hex, opacity) => {
    ...
    updateFromInput(dontFireEvent, element) {
        ...
        (this.element || element).trigger('change._lev_colorpicker', [element, hex, opacity]);
    ...
    updateFromPicker(input, target) {
        ...
        // Handle change event
        this.element.trigger('change._lev_colorpicker', [this.element, hex, this.opacity]);
...
export let Instance = new ColorpickerField('[data-lev-colorpicker]');
