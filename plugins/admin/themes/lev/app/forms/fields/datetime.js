...
export default class DateTimeField {
    ...
    constructor(options) {
        ...
        $('[data-lev-datetime]').each((index, field) => this.addItem(field));
    ...
    addItem(list) {
        ...
        let options = Object.assign({}, this.options, list.data('lev-datetime') || {});
    ...
    _onAddedNodes(event, target/* , record, instance */) {
        let fields = $(target).find('[data-lev-datetime]');
