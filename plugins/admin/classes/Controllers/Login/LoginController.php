...
namespace Lev\Plugin\Admin\Controllers\Login;
...
use Lev\Plugin\Admin\Controllers\AdminController;
 ...
 * @package Lev\Plugin\Admin\Controllers\Login
 */
class LoginController extends AdminController
{
    ...
    public function taskTwofa(): ResponseInterface
    {
        ...
        Lev::instance()['user']->authorized = true;
    ...
    public function taskForgot(): ResponseInterface
    {
        ...
        $this->lev['twig']->init();
        $body = $this->lev['twig']->processTemplate('email/base.html.twig', ['content' => $content]);
    ...
    private function doRegistration(array $data, array $files): void
    {
        ...
        $login = $this->getLogin();
        if (!$login) {
            throw new \RuntimeException($this->lev['language']->translate('PLUGIN_LOGIN.PLUGIN_LOGIN_DISABLED', 500));
        }
