...
use Lev\Common\Config\CompiledBlueprints;
use Lev\Common\Config\CompiledConfig;
use Lev\Common\Config\CompiledLanguages;
use Lev\Common\Config\Config;
use Lev\Common\Config\ConfigFileFinder;
use Lev\Common\Config\Setup;
use Lev\Common\Language\Language;
use Lev\Framework\Mime\MimeTypes;
...
class ConfigServiceProvider implements ServiceProviderInterface
{
    ...
    public static function blueprints(Container $container)
    {
        ...
        $blueprints = new CompiledBlueprints($cache, $files, LEV_SITE_DIR);
    ...
    public static function load(Container $container)
    {
        ...
        $compiled = new CompiledConfig($cache, $files, LEV_SITE_DIR);
    ...
    public static function languages(Container $container)
    {
        ...
        $languages = new CompiledLanguages($cache, $files, LEV_SITE_DIR);
