...
use Lev\Common\Flex\Types\Users\Storage\UserFileStorage;
use Lev\Common\Flex\Types\Users\Storage\UserFolderStorage;
use Lev\Common\Lev;
...
class FlexServiceProvider implements ServiceProviderInterface
{
    ...
    {
        $container['flex'] = function (Lev $container) {
            /** @var Config $config */
