...
/**
 * @deprecated 1.7 Use $lev['user_groups'] instead of this class. In type hints, please use UserGroupInterface.
 */
class Group extends Data
{
     ...
     *
     * @return array
     * @deprecated 1.7, use $lev['user_groups'] Flex UserGroupCollection instead
     */
    protected static function groups()
    {
        user_error(__METHOD__ . '() is deprecated since Lev 1.7, use $lev[\'user_groups\'] Flex UserGroupCollection instead', E_USER_DEPRECATED);

        return Lev::instance()['config']->get('groups', []);
    }
    ...
    public function save()
    {
        ...
        $filename = CompiledYamlFile::instance($lev['locator']->findResource("config://{$type}.yaml"));
