...
/**
 * Trait UserTrait
 * @package Lev\Common\User\Traits
 */
trait UserTrait
{
    /**
    ...
    public function authenticate(string $password): bool
    {
        ...
        if (!$isHashed) {
            ...
            $hash = Lev::instance()['config']->get('system.security.default_hash');
        }
    ...
    public function getAvatarUrl(): string
    {
        ...
        $avatar_generator = Lev::instance()['config']->get('system.accounts.avatar', 'multiavatar');
