...
class Security
{
    ...
    {
        if (file_exists($filepath) && Lev::instance()['config']->get('security.sanitize_svg')) {
    ...
    {
        if (Lev::instance()['config']->get('security.sanitize_svg')) {
    ...
    {
        if (file_exists($file) && Lev::instance()['config']->get('security.sanitize_svg')) {
            $sanitizer = new DOMSanitizer(DOMSanitizer::SVG);
