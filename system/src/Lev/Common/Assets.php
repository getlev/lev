...
use Closure;
use Lev\Common\Assets\Pipeline;
use Lev\Common\Assets\Traits\LegacyAssetsTrait;
use Lev\Common\Assets\Traits\TestingAssetsTrait;
...
class Assets extends PropertyObject
{
    ...
    /**
     * Initialization called in the Lev lifecycle to initialize the Assets with appropriate configuration
     *
     * @return void
     */
