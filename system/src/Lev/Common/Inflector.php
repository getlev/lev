...
class Inflector
{
    ...
    public static function init()
    {
        if (!static::$initialized) {
            ...
            if (!$language->isDebug()) {
                static::$plural = $language->translate('LEV.INFLECTOR_PLURALS', null, true);
                static::$singular = $language->translate('LEV.INFLECTOR_SINGULAR', null, true);
                static::$uncountable = $language->translate('LEV.INFLECTOR_UNCOUNTABLE', null, true);
                static::$irregular = $language->translate('LEV.INFLECTOR_IRREGULAR', null, true);
                static::$ordinals = $language->translate('LEV.INFLECTOR_ORDINALS', null, true);
            }
        }
    }
