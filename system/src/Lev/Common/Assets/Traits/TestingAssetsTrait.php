...
trait TestingAssetsTrait
{
     ...
     *
     * @param  string $directory Relative to the Lev root path, or a stream identifier
     * @param  string $pattern   (regex)
     * @return $this
     */
    public function addDir($directory, $pattern = self::DEFAULT_REGEX)
    {
        $root_dir = LEV_SITE_DIR;

        // Check if $directory is a stream.
        if (strpos($directory, '://')) {
            $directory = Lev::instance()['locator']->findResource($directory, null);
        }
