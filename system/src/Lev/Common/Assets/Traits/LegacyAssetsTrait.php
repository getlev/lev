...
/**
 * @package    Lev\Grav\Common\Assets\Traits
 *
 * @copyright  Copyright (c) 2015 - 2022 Levitation, LLC. All rights reserved.
 * @license    MIT License; see LICENSE file for details.
 */

namespace Lev\Common\Assets\Traits;
 ...
 * @package Lev\Common\Assets\Traits
 */
trait LegacyAssetsTrait
{
    /**
    ...
    {
        user_error(__CLASS__ . '::' . __FUNCTION__ . '() is deprecated since Lev 1.6, use dynamic method with [\'loading\' => \'async\']', E_USER_DEPRECATED);
    ...
    {
        user_error(__CLASS__ . '::' . __FUNCTION__ . '() is deprecated since Lev 1.6, use dynamic method with [\'loading\' => \'defer\']', E_USER_DEPRECATED);
