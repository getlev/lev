...
class TwigNodeRender extends Node implements NodeCaptureInterface
{
    ...
    public function compile(Compiler $compiler): void
    {
        ...
        $compiler
            ...
            ->write('if ($block instanceof \Lev\Framework\ContentBlock\ContentBlock && $html instanceof \Lev\Framework\ContentBlock\ContentBlock) {' . PHP_EOL)
            ->indent()
            ...
            ->write('} else {' . PHP_EOL)
            ->indent()
            ->write('\Lev\Common\Assets\BlockAssets::registerAssets($html);' . PHP_EOL)
