...
class ImageFile extends Image
{
    ...
    /**
     * This is the same as the Gregwar Image class except this one fires a Lev Event on creation of new cached file
     *
    ...
    public function cacheFile($type = 'jpg', $quality = 80, $actual = false, $extras = [])
    {
        ...
        $generate = function ($target) use ($image, $type, $quality) {
            ...
            Lev::instance()->fireEvent('onImageMediumSaved', new Event(['image' => $target]));
        };
    ...
    public function fixOrientation()
    {
        ...
        try {
            ...
            Lev::instance()['log']->error($filepath . ' - ' . $e->getMessage());
            return $this;
        }
