...
use Lev\Common\Media\Interfaces\ImageManipulateInterface;
...
use Lev\Common\Media\Traits\ImageMediaTrait;
...
class ImageMedium extends Medium implements ImageMediaInterface, ImageManipulateInterface
{
    ...
    public function url($reset = true)
    {
        ...
        $output = preg_replace('|^' . preg_quote(LEV_SITE_DIR, '|') . '|', '', $saved_image_path) ?: $saved_image_path;
        ...
        return trim($lev['base_url'] . '/' . $this->urlQuerystring($output), '\\');
    }
