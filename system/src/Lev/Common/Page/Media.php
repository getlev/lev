...
use Lev\Common\Lev;
use Lev\Common\Media\Interfaces\MediaObjectInterface;
use Lev\Common\Yaml;
use Lev\Common\Page\Medium\AbstractMedia;
use Lev\Common\Page\Medium\GlobalMedia;
...
class Media extends AbstractMedia
{
    ...
    protected function init()
    {
        ...
        $exif_reader = isset($lev['exif']) ? $lev['exif']->getReader() : null;
