...
class FormFlash implements FormFlashInterface
{
    ...
    {
        // Backwards compatibility with Lev 1.6 plugins.
        if (!is_array($config)) {
            user_error(__CLASS__ . '::' . __FUNCTION__ . '($sessionId, $uniqueId, $formName) is deprecated since Lev 1.6.11, use $config parameter instead', E_USER_DEPRECATED);
    ...
    {
        user_error(__CLASS__ . '::' . __FUNCTION__ . '() is deprecated since Lev 1.6.11, use ->getUniqueId() method instead', E_USER_DEPRECATED);
