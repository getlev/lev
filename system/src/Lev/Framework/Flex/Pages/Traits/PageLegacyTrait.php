...
namespace Lev\Framework\Flex\Pages\Traits;
...
use Lev\Framework\Flex\Pages\FlexPageCollection;
use Lev\Framework\Flex\Pages\FlexPageIndex;
...
trait PageLegacyTrait
{
    ...
    public function expires($var = null): int
    {
        return $this->loadHeaderProperty(
            ...
            static function ($value) {
                return (int)($value ?? Lev::instance()['config']->get('system.pages.expires'));
            }
        );
    }
    ...
    public function cacheControl($var = null): ?string
    {
        return $this->loadHeaderProperty(
            ...
            $var,
            static function ($value) {
                return ((string)($value ?? Lev::instance()['config']->get('system.pages.cache_control'))) ?: null;
            }
        );
    }
    ...
    public function metadata($var = null): array
    {
        ...
        if (null === $this->_metadata) {
            ...
            $defaultMetadata = ['generator' => 'LevCMS'];
    ...
    public function eTag($var = null): bool
    {
        return $this->loadHeaderProperty(
            ...
            $var,
            static function ($value) {
                return (bool)($value ?? Lev::instance()['config']->get('system.pages.etag'));
            }
        );
    }
    ...
    public function orderDir($var = null): string
    {
        return $this->loadHeaderProperty(
            ...
            $var,
            static function ($value) {
                return strtolower(trim($value) ?: Lev::instance()['config']->get('system.pages.order.dir')) === 'desc' ? 'desc' : 'asc';
            }
        );
    }
    ...
    public function orderBy($var = null): string
    {
        return $this->loadHeaderProperty(
            ...
            $var,
            static function ($value) {
                return trim($value) ?: Lev::instance()['config']->get('system.pages.order.by');
            }
        );
    }
    ...
    public function maxCount($var = null): int
    {
        return $this->loadHeaderProperty(
            ...
            $var,
            static function ($value) {
                return (int)($value ?? Lev::instance()['config']->get('system.pages.list.count'));
            }
        );
    }
