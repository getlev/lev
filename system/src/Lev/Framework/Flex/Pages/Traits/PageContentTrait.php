...
trait PageContentTrait
{
    ...
    public function process($var = null): array
    {
        return $this->loadHeaderProperty(
            ...
            $var,
            function ($value) {
                $value = array_replace(Lev::instance()['config']->get('system.pages.process', []), is_array($value) ? $value : []);
    ...
    public function lastModified($var = null): bool
    {
        return $this->loadHeaderProperty(
            ...
            $var,
            static function ($value) {
                return (bool)($value ?? Lev::instance()['config']->get('system.pages.last_modified'));
            }
        );
    }
    ...
    protected function processContent($content): string
    {
        ...
        if (null === $this->_content) {
            ...
            $this->_content = $content;
            $lev->fireEvent('onPageContentRaw', new Event(['page' => $this]));
            ...
            if ($twig_first && !$never_cache_twig) {
                ...
                $lev->fireEvent('onPageContentProcessed', new Event(['page' => $this]));
            } else {
                if ($process_markdown) {
        ...
        $lev->fireEvent('onPageContent', new Event(['page' => $this]));
