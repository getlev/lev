...
use Lev\Framework\Flex\Pages\Traits\PageAuthorsTrait;
use Lev\Framework\Flex\Pages\Traits\PageContentTrait;
use Lev\Framework\Flex\Pages\Traits\PageLegacyTrait;
use Lev\Framework\Flex\Pages\Traits\PageRoutableTrait;
use Lev\Framework\Flex\Pages\Traits\PageTranslateTrait;
...
class FlexPageObject extends FlexObject implements PageInterface, FlexTranslateInterface
{
    ...
    {
        return Lev::instance()['accounts'] ?? null;
    }
}
