...
use Lev\Framework\Object\ObjectIndex;
use Monolog\Logger;
...
class FlexIndex extends ObjectIndex implements FlexIndexInterface
{
    ...
    public function __construct(array $entries = [], FlexDirectory $directory = null)
    {
        ...
        if (get_class($this) === __CLASS__) {
            user_error('Using ' . __CLASS__ . ' directly is deprecated since Lev 1.7, use \Lev\Common\Flex\Types\Generic\GenericIndex or your own class instead', E_USER_DEPRECATED);
        }
    ...
    {
        $this->_flexDirectory = Lev::instance()['flex']->getDirectory($data['type']);
