...
/**
 * Implements Lev Page content and header manipulation methods.
 */
trait FlexMediaTrait
{
    ...
    {
        user_error(__METHOD__ . '() is deprecated since Lev 1.7, use Media class that implements MediaUploadInterface instead', E_USER_DEPRECATED);
