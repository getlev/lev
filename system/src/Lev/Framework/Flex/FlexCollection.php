...
class FlexCollection extends ObjectCollection implements FlexCollectionInterface
{
    ...
    public function __construct(array $entries = [], FlexDirectory $directory = null)
    {
        ...
        if (get_class($this) === __CLASS__) {
            user_error('Using ' . __CLASS__ . ' directly is deprecated since Lev 1.7, use \Lev\Common\Flex\Types\Generic\GenericCollection or your own class instead', E_USER_DEPRECATED);
        }
