 ...
 */
class SandboxCommand extends LevCommand
{
    /** @var array */
    ...
    protected function configure(): void
    {
        $this
            ->setName('sandbox')
            ->setDescription('Setup of a base Lev system in your webroot, good for development, playing around or starting fresh')
            ->addArgument(
                'destination',
            ...
            ->addOption(
                ...
                'Symlink the base lev system'
            )
            ->setHelp("The <info>sandbox</info> command help create a development environment that can optionally use symbolic links to link the core of lev to the git cloned repository.\nGood for development, playing around or starting fresh");
    ...
    private function perms(): int
    {
        ...
        $binaries = glob($this->destination . '/' . 'bin' . '/' . '*');
