 ...
 */
class SecurityCommand extends LevCommand
{
    ...
    protected function configure(): void
    {
        $this
            ...
            ->setHelp('The <info>security</info> runs various security checks on your Lev site');
    }
    ...
    protected function serve(): int
    {
        ...
        /** @var Lev $lev */
        $lev = Lev::instance();
        $this->progress = new ProgressBar($this->output, count($lev['pages']->routes()) - 1);
        ...
        $io->title('Lev Security Check');
        $io->newline(2);

        $output = Security::detectXssFromPages($lev['pages'], false, [$this, 'outputProgress']);
