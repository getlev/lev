...
class UpdateCommand extends GpmCommand
{
    ...
    protected function configure(): void
    {
        $this
            ...
            ->addOption(
                ...
                'The lev instance location where the updates should be applied to. By default this would be where the lev cli has been launched from',
                LEV_SITE_DIR
            )
            ->addOption(
                'all-yes',
    ...
    protected function serve(): int
    {
        ...
        if ($local !== $remote) {
            $io->writeln('<yellow>WARNING</yellow>: A new version of Lev is available. You should update Lev before updating plugins and themes. If you continue without updating Lev, some plugins or themes may stop working.');
            $io->newLine();
